from liver_disease.entity.config_entity import ModelEvaluationConfig
from liver_disease.entity.artifact_entity import ModelTrainerArtifact, DataIngestionArtifact, ModelEvaluationArtifact
from sklearn.metrics import f1_score
from liver_disease.exception import INliverException
from liver_disease.constants import TARGET_COLUMN, CURRENT_YEAR
...
from liver_disease.entity.estimator import TargetValueMapping
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[INliverEstimator]:
        """
        ...
        try:
            ...
            usvisa_estimator = INliverEstimator(bucket_name=bucket_name,
