...
from liver_disease.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from liver_disease.entity.config_entity import ModelTrainerConfig
from liver_disease.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            usvisa_model = INDliverModel(preprocessing_object=preprocessing_obj,
