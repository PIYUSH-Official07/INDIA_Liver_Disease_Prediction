...
from liver_disease.cloud_storage.aws_storage import SimpleStorageService
from liver_disease.exception import INliverException
from liver_disease.logger import logging
from liver_disease.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact
from liver_disease.entity.config_entity import ModelPusherConfig
...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact,
        ...
        self.usvisa_estimator = INliverEstimator(bucket_name=model_pusher_config.bucket_name,
